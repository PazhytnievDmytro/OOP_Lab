...
## Цель работы: иллюстрация использования исключений для обработки исключительных ситуаций с использованием ключевых слов throw, try и catch. Демонстрация обработки исключений разных типов в рамках одного блока try-catch, восстановления программы после обработки исключения и создания пользовательских типов исключений.
